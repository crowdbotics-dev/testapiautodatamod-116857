...
## Project Structure
    ...
    ├── testapiautodatamod_116857  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_116857`
...
2. Clone this repo and `cd testapiautodatamod_116857`
